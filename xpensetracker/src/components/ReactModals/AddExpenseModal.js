...
export default function AddExpenseModal({ isOpen, handleCloseModal, totalExpense, setTotalExpense }) {
  ...
  const { balance, _setBalance } = useContext(BalanceContext);
    ...
    >
      <div>
        ...
        <div className='grid'>
          ...
          <input type="text" placeholder='Price' name='price' onChange={(e) => setFormData({ ...formData, price: e.target.value })} />
          ...
          <input type="text" name='date' placeholder='dd/mm/yy' onChange={(e) => setFormData({ ...formData, date: e.target.value })} />
